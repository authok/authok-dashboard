...
interface SocialConnectionSettingsProps {
  connection: API.Connection;
  onUpdate: (connection: API.Connection) => Promise<boolean>;
  onDelete: (id: string) => void;
}

const SocialConnectionSettings: React.FC<SocialConnectionSettingsProps> = ({ connection, onUpdate, onDelete }) => {
      ...
      actions={[
        <KeywordConfirmModal
          ...
          description={<>
            ...
            <ul>
              <li>将会永久删除 <b>{connection.name}</b> 社会化身份源 和所有其用户</li>
